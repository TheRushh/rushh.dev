  ...
  return (
    <section ref={ref as React.RefObject<HTMLElement>} id="about" className="reveal py-20 px-4">
      <div className="container mx-auto max-w-6xl">
        ...
        {/* My Journey */}
        <div className="relative p-6 rounded-2xl border border-base-content/5 bg-base-content/5 backdrop-blur-sm hover:bg-base-content/10 transition-colors mb-8">
          <div>
