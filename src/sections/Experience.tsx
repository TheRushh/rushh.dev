                ...
                <div key={index} className="relative">
                  ...
                  <div className="md:hidden flex gap-4">
                    ...
                    <div className="flex-1 pb-6">
                      <div
                        className="relative p-6 rounded-2xl border border-base-content/15 bg-base-300/80 hover:bg-base-200 transition-colors duration-300 cursor-pointer w-full group"
