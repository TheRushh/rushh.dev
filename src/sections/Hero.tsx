          ...
          >
            ...
            >
              ...
              <button
                ...
                className="px-8 h-12 flex items-center justify-center text-base font-semibold rounded-2xl border border-base-content/5 bg-base-100/30 backdrop-blur-sm hover:bg-base-100/50 hover:-translate-y-0.5 transition-all text-base-content group focus:outline-none focus:ring-2 focus:ring-base-content/20"
              >
                Get in Touch
              </button>
            </motion.div>
